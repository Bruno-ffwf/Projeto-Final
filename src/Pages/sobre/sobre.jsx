  ...
  return (
    <main className="mainsobre">
      ...
      <h2 className="h2sobre">
        Meu nome é Bruno Silva de Oliveira, tenho 20 anos e sou Dev front end.
        Moro em Santa Teresa, Rio de Janeiro, cria do morro dos prazeres e desde
        o momento em que segurei um controle de vídeo game fiquei apaixonado por
        tecnologia. Calmo e cabeça fria sempre tento achar formar criativas de
        resolver problemas, e sou um ótimo improvisador me adapto a todo tipo de
        situação.
      </h2>
